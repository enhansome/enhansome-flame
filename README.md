...
* [First-Party Plugins](https://github.com/flame-engine/flame/tree/main/packages) ⭐ 10,766 | 🐛 83 | 🌐 Dart | 📅 2026-09-22 - First-party plugins included in Flame's monorepo.
* [bonfire](https://github.com/RafaelBarbosatec/bonfire) ⭐ 1,471 | 🐛 6 | 🌐 Dart | 📅 2026-09-07 - RPG maker. By [rafaelbarbosatec](https://github.com/RafaelBarbosatec)
...
* [Ant Squash](https://github.com/sourabhgupta811/Ant-Squash) ⭐ 25 | 🐛 0 | 🌐 Dart | 📅 2024-02-16 - A simple casual bug squashing game that you can play with one finger. Tap to kill, stop ants from eating the sweet! By [Sourabh Gupta](https://www.linkedin.com/in/sourabhgupta811/)
...
* [Dino Run](https://github.com/ufrshubham/dino_run) ⭐ 251 | 🐛 0 | 🌐 Dart | 📅 2026-04-04 - A 2D infinite side scroller mobile game made in Flutter using Flame engine. Get it on [Play Store](https://play.google.com/store/apps/details?id=com.nobs.dino_run). By [DevKage][1].

* [BGUG](https://github.com/fireslime/bgug) ⭐ 98 | 🐛 0 | 🌐 Dart | 📅 2020-07-27 - Break Guns Using Gems is a fast paced side-scrolling platformer with innovative controls and and a gun-related twist. By [FireSlime](https://fireslime.xyz)
...
* [Darkness Dungeon](https://github.com/RafaelBarbosatec/darkness_dungeon) ⭐ 469 | 🐛 1 | 🌐 Dart | 📅 2025-01-12 - Simple RPG. By [rafaelbarbosatec](http://rafaelbarbosatec.github.io/)

#### Strategy

* [Age of New Worlds](https://github.com/ernestwisniewski/aonw) ⚠️ Archived - An open-source 4X strategy game built with Flutter and Flame, featuring hex maps, turn-based empire building, AI players, and multiplayer foundations. By [ernestwisniewski](https://github.com/ernestwisniewski).
...
* [Mandarin Chinese (中文)](https://github.com/flame-engine/awesome-flame/blob/main/CONTENT_ZH.md) ⭐ 1,384 | 🐛 0 | 📅 2026-08-31
* [Spanish (Español)](https://github.com/flame-engine/awesome-flame/blob/main/CONTENT_ES.md) ⭐ 1,384 | 🐛 0 | 📅 2026-08-31

## Contributing

[Please read the contribution guidelines](https://github.com/flame-engine/awesome-flame/blob/main/CONTRIBUTING.md) ⭐ 1,384 | 🐛 0 | 📅 2026-08-31
